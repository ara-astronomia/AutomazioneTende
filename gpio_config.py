...
class GPIOConfig(metaclass=Singleton):
    ...
    def add_event_detect_on(self, switch, callback, bouncetime=0):
        self.add_event_detect(switch, GPIO.FALLING, callback, bouncetime)

    def add_event_detect_off(self, switch, callback, bouncetime=0):
